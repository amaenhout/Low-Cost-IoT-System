...
def uplink_callback(msg, client):
	...
	print("start")
        ...
        engine = create_engine('mysql+pymysql://ttn:Amemvs02@localhost:3306/bartlett_workshop?charset=utf8mb4')
    
        #push to local server
        try:
            df.to_sql("ttn_mot",con = engine, if_exists = 'append', index = False)
            print("Data in sql")
